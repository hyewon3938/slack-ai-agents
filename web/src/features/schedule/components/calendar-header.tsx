...
export function CalendarHeader({
  ...
  return (
    ...
    <div className="mx-auto flex max-w-5xl flex-wrap items-center gap-2">
      ...
      <button
        onClick={onAdd}
        className="fixed right-4 bottom-[calc(5rem+env(safe-area-inset-bottom))] z-40 flex h-14 w-14 items-center justify-center rounded-full bg-blue-500 text-2xl text-white shadow-lg transition hover:bg-blue-600 md:hidden"
      >
        +
      </button>
    </div>
