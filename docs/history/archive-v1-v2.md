# 프로젝트 히스토리 — Archive (2026-03-05 ~ 2026-04-07)

이 문서는 프로젝트 초기 마일스톤 기록의 archive다.

- **시기**: 2026-03-05 프로젝트 시작 ~ 2026-04-07 (Phase 0~5 + v1 회고 + v2 설계 + 초기 기능)
- 활성 timeline은 [project-history.md](../project-history.md) 참조
- 설계 판단(ADR)은 [adr/](../adr/) 참조
