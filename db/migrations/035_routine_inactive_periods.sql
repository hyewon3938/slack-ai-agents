...
ALTER TABLE routine_templates ADD COLUMN IF NOT EXISTS start_date DATE;
...
-- 비활성 기간 테이블
CREATE TABLE IF NOT EXISTS routine_inactive_periods (
...
CREATE INDEX IF NOT EXISTS idx_routine_inactive_template ON routine_inactive_periods(template_id);
CREATE INDEX IF NOT EXISTS idx_routine_inactive_user ON routine_inactive_periods(user_id);
