...
<!-- ![수면 기록 대화 — 주간 패턴 리뷰](docs/images/03-sleeping.png) -->
...
<!-- TODO: 데스크탑 스크린샷 추가 -->
<!-- ![웹 대시보드 — 데스크탑 캘린더 뷰](docs/images/01-web-dashboard-desktop.png) -->

<!-- TODO: 모바일 스크린샷 추가 -->
<!-- ![웹 대시보드 — 모바일 캘린더 뷰](docs/images/01-web-dashboard-mobile.png) -->
